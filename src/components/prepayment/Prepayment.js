...
export default class Prepayment extends Component {
    ...
    render () {
        ...
        let salaryOne = salary / workDays * prepaymentDay;   
        let withTaxesOne = withTaxes / workDays * prepaymentDay;
                    ...
                    <Grid container justify="space-between">
                        ...
                        <Grid item xs={6}>
                            <FormControl>
                                ...
                                <FormHelperText>Кількість відпрацьованих днів в першій половині місяця</FormHelperText>
                            </FormControl>
                        </Grid>
                    </Grid>
                </form>
                    ...
                    <Paper>
                        <Table>
                          ...
                          <TableRow>
                                ...
                                <TableCell align="center">{formatNumber.format(salaryOne)}</TableCell>
                              </TableRow>
              
                          </TableBody>
                        </Table>
                        <Box  p={4}>
                          <Typography>Загалом податків: {formatNumber.format(taxes/workDays*prepaymentDay)}</Typography>  
                          <Typography>Загалом витрат(зарплата + податки): {formatNumber.format(taxes/workDays*prepaymentDay + +salary/workDays*prepaymentDay)}</Typography>          
                        </Box>
                      </Paper>
                      <Paper>
                        <Table>
                          ...
                          <TableRow>
                                ...
                                <TableCell align="center">{formatNumber.format(salary-salaryOne)}</TableCell>
                              </TableRow>
              
                          </TableBody>
                        </Table>
                        <Box  p={4}>
                          <Typography>Загалом податків: {formatNumber.format(taxes/workDays*secondPart)}</Typography>  
                          <Typography>Загалом витрат(зарплата + податки): {formatNumber.format(taxes/workDays*secondPart + +salary/workDays*secondPart)}</Typography>          
                        </Box>
                      </Paper>
                      </Box>
                      ) :
